          ...
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a className="text-indigo-400 leading-relaxed">
                mattgrogan.dev@gmail.com
              </a>
              <h2 className="title-font font-semibold text-white tracking-widest text-xl mt-4">
                PHONE
              </h2>
              <p className="leading-relaxed text-indigo-400">(520)-210-2130</p>
              <h2 className="title-font font-semibold text-white tracking-widest text-xl mt-4">
                LOCATION
              </h2>
              <p className="leading-relaxed text-indigo-400">Tucson, AZ</p>
            </div>
          </div>
        </div>
        <form
          ...
          <p className="leading-relaxed mb-5">
            Contact me by phone, email, or by filling out the form below. I look
